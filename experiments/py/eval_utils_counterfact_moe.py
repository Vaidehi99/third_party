...
# from util.fewshot_utils import make_inputs, make_inputs_image, score_from_batch
...
def compute_rewrite_quality_counterfact(
    ...
    # adding parap_image_pron
    ret_probs = ret_probs + [probs_image]
...
def test_batch_prediction_image(
    args,
    model,
    tok,
    image_processor,
